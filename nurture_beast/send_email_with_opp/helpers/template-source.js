...
>
  <head>
    ...
    <style media="screen and (min-width:480px)">
      .moz-text-html .mj-column-per-300 {
        width: 100% !important;
        max-width: 100%;
      }
    ...
    <style type="text/css">
      ...
      @media (max-width: 480px) {
        .mj-small-device-hidden-element {
          display: none !important;
        }
      }
    </style>
                        ...
                        >
                          <tbody>
                            <tr>
                              ...
                              >
                                <a
                                  href="https://app.gohighlevel.com/v2/location/{{locationId}}/opportunities/list"
                                  style="
                                    display: inline-block;
                                    background: #2196f3;
                                    color: #ffffff;
